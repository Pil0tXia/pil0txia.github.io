...
var SantaGame = {
	...
	load: {
		preload: function(){
			this.game.load.audio('drivin-home', './drivin-home-low.mp3');
			this.game.load.audio('ho-ho-ho', './ho-ho-ho.mp3');
			this.game.load.audio('hop', './jump-sound.mp3');
			this.game.load.image('platform', './ground.png');
			this.game.load.spritesheet('santa-running', './santa-running.png', 37, 52);
			this.game.load.image('snow-bg', './snow-bg.png');
			this.game.load.image('snowflake', './snowflake.png');
			this.game.load.image("logo", "./game-logo.png");
			this.game.load.image("instructions", "./instructions.png");
			this.game.load.image("game-over", "./game-over.png");
			this.game.load.image("startbtn", "./start-btn.png");
			this.game.load.image("playbtn", "./play-btn.png");
			this.game.load.image("restartBtn", "./restart-btn.png");
		},
		create: function(){
